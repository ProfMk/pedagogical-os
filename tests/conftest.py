...
from tests.fixtures.real_school_dataset import real_school_dataset
from tests.fixtures.load_test_seed import load_sql_file

# import fixture so pytest discovers it
from tests.fixtures.academic_context import academic_context
